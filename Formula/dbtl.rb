class Dbtl < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/hytfjwr/dbtl/releases/download/v0.1.1/dbtl-v0.1.1-aarch64-apple-darwin.tar.gz"
      sha256 "7cecd4c418c5723e9b11957dc2246f05b361e78cf3b870ff15724a127353f166"
    end
    on_intel do
      url "https://github.com/hytfjwr/dbtl/releases/download/v0.1.1/dbtl-v0.1.1-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/hytfjwr/dbtl/releases/download/v0.1.1/dbtl-v0.1.1-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "fffffc6ef963081a421dde38bed47ec730987f6451678f36bb8432fb54dca55f"
    end
    on_intel do
      url "https://github.com/hytfjwr/dbtl/releases/download/v0.1.1/dbtl-v0.1.1-x86_64-unknown-linux-gnu.tar.gz"
